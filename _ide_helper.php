 ...
 */
     ...
     */ 
        ...
        {
                        /** @var \App\Services\Auth\MyTokenGuard $instance */
         ...
         * @static 
         */ 
        public static function attempt($credentials = [], $remember = true)
        {
                        /** @var \App\Services\Auth\MyTokenGuard $instance */
        ...
        {
                        /** @var \App\Services\Auth\MyTokenGuard $instance */
                        return $instance->issueToken($user);
        }
                    /**
         * 
         *
        ...
        {
                        /** @var \App\Services\Auth\MyTokenGuard $instance */
                        return $instance->updateRequest($request);
        }
                    /**
         * Retrieve a user by their unique identifier.
         *
         ...
         *
         * @param \Illuminate\Contracts\Auth\Authenticatable $user
         * @return \App\Services\Auth\MyTokenGuard 
         * @static 
         */ 
